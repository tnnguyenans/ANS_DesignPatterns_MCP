# Builder Design Pattern-RealWorld
...
/**
 *These preprocessor directives allow this standalone code to target both
...
/**
 *The html namespace contains the core machinery of the Fluent Builder
...
/**
 *The forward declaration for the ElementBuilder is necessary as it is
 * a friend class of the Element class in this Fluent Builder implementation.
 */
class ElementBuilder;

/**
 *Enumeration to represent different HTML elements. (Note that in C++11
...
/**
 *This client-facing Element class is essentially a tree node that
...
class Element {
 public:
  ...
  /**
   *The print method generates markup. Note that the ranged-based for
...
/**
 *The Fluent Builder is named for its method chaining as the modifier
