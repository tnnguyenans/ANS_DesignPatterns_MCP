# Singleton Design Pattern-RealWorld
...
public:
  /**
   *Various levels for the log messages can be labelled here; the choice of
...
/**
 *Static members of the Logger class need to be defined outside of the
 * class itself.
 */
